  ...
  return (
    <div className="prose prose-lg mx-auto dark:text-white prose-h1:dark:text-white prose-h2:dark:text-white">
      ...
      <p>
        ...
        and recorded by dinakar and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        website with regards to the information that they shared and/or collect in dinakar. This
      ...
      <h2>Log Files</h2>
      <p>
        Our website(dinakar.co.in) follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, dinakar uses ‘cookies’. These cookies are used to store information
      ...
      <p>
        ...
        <a href="https://www.privacypolicyonline.com/what-are-cookies/" about="_blank">
          "What Are Cookies"
        </a>{' '}
        from Cookie Consent.
      </p>
      ...
      <p>
        ...
        cookies, to serve ads to our site visitors based upon their visit to dinakar.com and other
      ...
      <p>
        ...
        Beacons that are used in their respective advertisements and links that appear on dinakar,
      ...
      <p>
        Note that dinakar has no access to or control over these cookies that are used by
        third-party advertisers.
      </p>
      <h2>Third Party Privacy Policies</h2>
      <p>
        Dinakar's Privacy Policy does not apply to other advertisers or websites. Thus, we are
      ...
      <p>
        Dinakar does not knowingly collect any Personal Identifiable Information from children under
      ...
      <p>
        ...
        your computer or mobile device (referred to in this policy as a “device”) by the web server
        so that a website can remember some information about your browsing activity on the Website.
      </p>
      <p>
        ...
        similar technologies (collectively, “Tags”) may be placed on the Website to monitor
        interaction with advertising content and to target and optimize advertising. Each internet
        browser has functionality so that you can block both first and third-party cookies and clear
        your browser’s cache. The "help" feature of the menu bar on most browsers will tell you how
        to stop accepting new cookies, how to receive notification of new cookies, how to disable
        existing cookies and how to clear your browser’s cache. For more information about cookies
        and how to disable them, you can consult the information at All About Cookies.
      </p>
      <p>
      ...
      <p>
        Mediavine Partners (companies listed below with whom Mediavine shares data) may also use
        this data to link to other end user information the partner has independently collected to
        deliver targeted advertisements. Mediavine Partners may also separately collect data about
        end users from other sources, such as advertising IDs or pixels, and link that data to data
        collected from Mediavine publishers in order to provide interest-based advertising across
        your online experience, including devices, browsers and apps. This data includes usage data,
        cookie information, device information, information about interactions between users and
        advertisements and websites, geolocation data, traffic data, and information about a
        visitor’s referral source to a particular website. Mediavine Partners may also create unique
        IDs to create audience segments, which are used to provide targeted advertising.
      </p>
      <p>
        If you would like more information about this practice and to know your choices to opt-in or
        opt-out of this data collection, please visit National Advertising Initiative opt out page.
        You may also visit Digital Advertising Alliance website and Network Advertising Initiative
        website to learn more information about interest-based advertising. You may download the
        AppChoices app at Digital Advertising Alliance’s AppChoices app to opt out in connection
        with mobile apps, or use the platform controls on your mobile device to opt out.
      </p>
      <p>
        For specific information about Mediavine Partners, the data each collects and their data
        collection and privacy policies, please visit Mediavine Partners.
      </p>
    </div>
  )
}
