...
const index = () => {
  return (
    <div className="prose prose-lg mx-auto">
      ...
      <p>
        These terms and conditions outline the rules and regulations for the use of dinakar's
        Website, located at dinakar.co.in.
      </p>
      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue
        to use dinakar if you do not agree to take all of the terms and conditions stated on this
        page.
      </p>
      <p>
      ...
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By accessing dinakar, you agreed to use cookies in agreement
        with the dinakar's Privacy Policy.
      </p>
      <p>
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, dinakar and/or its licensors own the intellectual property rights
        for all material on dinakar. All intellectual property rights are reserved. You may access
        this from dinakar for your own personal use subjected to restrictions set in these terms and
        conditions.
      </p>
      <p>You must not</p>
      <ul>
        <li>Republish material from Dinakar</li>
        <li>Sell, rent or sub-license material from dinakar</li>
        <li>Reproduce, duplicate or copy material from dinakar</li>
        <li>Redistribute content from diankar</li>
      </ul>
      <p>
        ...
        dinakar does not filter, edit, publish or review Comments prior to their presence on the
        website. Comments do not reflect the views and opinions of dinakar, its agents and/or
        affiliates. Comments reflect the views and opinions of the person who posted their views and
        opinions. To the extent permitted by applicable laws, dinakar shall not be liable for the
      ...
      <p>
        Dinakar reserves the right to monitor all Comments and to remove any Comments which can be
      ...
      <p>
        You hereby grant dinakar a non-exclusive license to use, reproduce, edit and authorize
      ...
      <p>
        ...
        visibility of the hyperlink compensates the absence of dinakar; and (d) the link is in the
      ...
      <p>
        ...
        linking to our website, you must inform us by sending an e-mail to dinakar. Please include
      ...
      <p>
        No use of dinakar's logo or other artwork will be allowed for linking absent a trademark
        license agreement.
      </p>
      <h2>iFrames</h2>
      <p>
